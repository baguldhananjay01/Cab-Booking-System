...
public class CabRouteAddDTO {
	...
	public List<CabRouteDTO> getCabRoutesList() {
		return cabRoutesList;
	}

	public void setCabRoutesList(List<CabRouteDTO> cabRoutesList) {
		this.cabRoutesList = cabRoutesList;
	}
